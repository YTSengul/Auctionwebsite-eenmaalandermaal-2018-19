...
Function auctionBoxes($boxTitle, $size, $auctionClass, $amountOfAuctions, $amountHidden, $sortFilter = "Startprijs", $upOrDown = "DESC")
{
    ...
    while ($auction = $auctions->fetch()) {
        ...
        echo '
            ...
            if(c_file_exists('http://iproject4.icasites.nl/thumbnails/' . $auction['Thumbnail'])) {
                echo '<img src="http://iproject4.icasites.nl/thumbnails/' . $auction['Thumbnail'] . '" alt="Auction Photo">';
            } else {
