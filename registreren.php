...
if (isset($_POST["registreer"])) {
    $sql_gebruikersnaam_check = "select * from gebruiker where gebruikersnaam = 'Thelion'";
...
<div class="grid-container">
        ...
        <div class="grid-x grid-padding-x">
            <div class="medium-12 large-12 float-center cell">
                <label>Gebruikersnaam
                    <input <?php if($gebruikersnaam_validation == $invalid) {echo 'class="is-invalid-input"';} ?> name="gebruikersnaam" type="text" placeholder="Uw gebruikersnaam" required>
                </label>
                <?php if($gebruikersnaam_validation == $invalid) {echo '<span class="form-error is-visible" id="exemple2Error">Deze gebruikersnaam bestaat al.</span>';} ?>
                <label>Wachtwoord
                    <input <?php if($wachtwoord_validation == $invalid) {echo 'class="is-invalid-input"';} ?> name="wachtwoord1" type="text" placeholder="Wachtwoord" required>
                </label>
                <label>Herhaal wachtwoord
                    <input <?php if($wachtwoord_validation == $invalid) {echo 'class="is-invalid-input"';} ?> name="wachtwoord2" type="text" placeholder="Herhaal wachtwoord" required>
                    <?php if($wachtwoord_validation == $invalid) { echo '<span class="form-error is-visible" id="exemple2Error">Wachtwoorden komen niet overeen.</span>';} ?>
                </label>
                <label>Voornaam
    ...
    if (isset($_POST["registreer"])) {
        ...
        $sql_registreer = "insert into gebruiker ([gebruikersnaam], [voornaam], [achternaam], [adresregel1], [adresregel2], [postcode], [plaatsnaam], [land], [datum], [mailbox], [vraagnummer], [antwoordtekst]) values ('$gebruikersnaam', '$voornaam', '$achternaam', '$adresregel1', '$adresregel2', '$postcode', '$plaatsnaam', '$land', '$geboortedatum', '$emailadres', $veiligheidsvraag, '$antwoord_op_veiligheidsvraag')";

        print "<br>" . ($sql_registreer);

        print "<br>" . ($gebruikersnaam) . "<br>";
        ...
        //echo 'Formulier nog niet ingevuld';
    }
